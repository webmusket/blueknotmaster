...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_axios__ = __webpack_require__(30);
...
Nova.booting(function (Vue, router, store) {
  ...
  Vue.use(__WEBPACK_IMPORTED_MODULE_1_vue_axios___default.a, __WEBPACK_IMPORTED_MODULE_0_axios__["default"]);

  Vue.component('index-super-category', __webpack_require__(31));
  Vue.component('detail-super-category', __webpack_require__(34));
  Vue.component('form-super-category', __webpack_require__(37));
});
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'C:\\xampp_new\\htdocs\\finalproject1\\nova-components\\SuperCategory\\node_modules\\axios\\index.js'");
...
var update = __webpack_require__(41)("c9c9da74", content, false, {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(44);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    var uri = '/getcategories';
    this.axios.get(uri).then(function (response) {
      _this.categories = main(response.data);
    });
  },
  mounted: function mounted() {

    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#addcat').hide();

    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#showadd').click(function (e) {
      e.preventDefault();
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#addcat').show();
  ...
  methods: {
    ...
    setInitialValue: function setInitialValue() {
      if (typeof this.field.value == 'string') {
        this.value = this.field.value.split(',').map(function (elem) {
          return Number(elem);
        }) || [];
      } else {
    ...
    updatecategory: function updatecategory() {
      ...
      var uri = '/update-category';
      this.axios.post(uri, this.addcategory).then(function (response) {
        // Display a warning toast, with no title
        _this2.value.push(response.data);
        var key = response.data;

        var url = '/getcategories';
        _this2.axios.get(url).then(function (response) {
          _this2.categories = main(response.data);
        });
      });
    }
  }
      ...
      _c("template", { slot: "field" }, [
        _c(
          ...
          [
            _c(
              "div",
              { attrs: { id: "scrollcheck" } },
              [
                _c("div", { attrs: { id: "latestcategory" } }),
                _vm._v(" "),
                _vm._l(_vm.catnames, function(cat) {
                  return _c(
                    "div",
                    {
                      key: cat[0],
                    ...
                    [
                      ...
                      _vm._v(" "),
                      cat[2] == 4
                        ? _c("span", { staticStyle: { "margin-left": "80px" } })
                        : _vm._e(),
                      _vm._v(" "),
                      _c("checkbox", {
                        staticClass: "pr-2",
                        attrs: {
                          value: cat[0],
                          checked: _vm.isChecked(cat[0])
                        },
                        on: {
                          input: function($event) {
                            return _vm.toggleOption(cat[0])
                          }
                        }
                      }),
                      _vm._v(" "),
                      _c("label", {
                        staticClass: "w-full",
                        attrs: { for: _vm.category },
                        domProps: { textContent: _vm._s(cat[1]) },
                        on: {
                ...
                _c("div", { attrs: { id: "addcat" } }, [
                  _c("div", { staticClass: "form-group" }, [
                    _c("input", {
                      ...
                      domProps: { value: _vm.addcategory.name },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.addcategory, "name", $event.target.value)
                        }
                      }
                    })
                  ]),
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.addcategory.parent,
                          expression: "addcategory.parent"
                        }
                      ],
                      staticClass: "form-control",
                      on: {
